...
@section('title', 'Evento | Editar Tipo de Evento')

@section('content_header')
    <h1>Evento | Editar Tipo de Evento</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <!-- /.card-header -->
                <form action="{{ route('tipo_evento.update',$tipoEvento->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" maxlength="15" value="{{ $tipoEvento->name }}">
