...
@section('title', 'Evento | Editar Tipo de Transmissão')

@section('content_header')
    <h1>Evento | Editar Tipo de Transmissão</h1>
@stop
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <!-- /.card-header -->
                <form action="{{ route('tipo_transmissao.update',$tipoTransmissao->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="titulo" id="titulo" maxlength="15" value="{{ $tipoTransmissao->titulo }}">
